...
# These are the guids for the published official maps in DRA
OFFICIAL_MAPS: Dict[str, Dict[str, str]] = {
    ...
    "MT": {"congress": "66ff2b64-826d-48a9-bbe4-08afa4c10873"},
    "NE": {
...
# These are the guids for *copies* of the published official maps in DRA
OFFICIAL_MAPS_COPY: Dict[str, Dict[str, str]] = {}


# TODO - Update this
# These are the guids for the published notable maps in DRA
...
}  # This structure was autogenerated using the make_notables_guids_dict.py script. It was populated by hand on TODO: mm-dd-yy.

# TODO: Update this
# These are the guids for *copies* of the published notable maps in DRA,
