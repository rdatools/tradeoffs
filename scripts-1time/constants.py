...
# TODO - Update this
# These are the ids for the published notable maps in DRA
...
}  # This structure was autogenerated using the make_notables_ids_dict.py script. It was populated by hand on TODO: mm-dd-yy.
